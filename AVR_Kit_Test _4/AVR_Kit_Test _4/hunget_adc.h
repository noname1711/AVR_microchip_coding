...
#define ADC_AUTO() 			ADCSRA |= (1<<ADATE)	// ADATE = 1: tu dong chuyen doi khi co su kien trigger
#define ADC_STA_CONVERT() 	ADCSRA |= (1<<ADSC)		// ADSC = 1: bat dau chuyen doi, duoc xoa khi hoan tat
